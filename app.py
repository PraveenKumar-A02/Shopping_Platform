...
app.config['MAIL_USERNAME'] = os.getenv('MAIL_USERNAME', 'benhiveamsdev@gmail.com') 
app.config['MAIL_PASSWORD'] = os.getenv('MAIL_PASSWORD', 'rkczyubezhufyknv') 
...
def send_email(subject, body, to_email):
    msg = MIMEText(body)
    msg['Subject'] = subject
    msg['From'] = formataddr(('Shopping Platform', app.config['MAIL_USERNAME']))
    msg['To'] = to_email
...
class UserProfileResource(Resource):
    ...
    def get(self):
        ...
        return {'status': True, 'username': current_user['username']}
